...
mixin _$DownloadsState {
  ...
  Option<Either<MainFailures, List<Downloads>>> get downloadsFailure =>
      throw _privateConstructorUsedError;
...
abstract class $DownloadsStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Option<Either<MainFailures, List<Downloads>>> downloadsFailure});
}
    ...
    return _then(_value.copyWith(
      ...
      downloads: freezed == downloads
          ...
          : downloads // ignore: cast_nullable_to_non_nullable
              as List<Downloads>?,
      downloadsFailure: null == downloadsFailure
...
class _$_DownloadsState implements _DownloadsState {
  ...
  @override
  final Option<Either<MainFailures, List<Downloads>>> downloadsFailure;

  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downloads: $downloads, downloadsFailure: $downloadsFailure)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.downloadsFailure, downloadsFailure) ||
                other.downloadsFailure == downloadsFailure));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isLoading,
      const DeepCollectionEquality().hash(_downloads), downloadsFailure);
